...
Thefts spiked during the spike year but have decreased but they are not as low as the pre-spike years
...
Car thefts are down from spike era but higher than pre-2023 numbers. 
...
- **Null Hypothesis (H0)**: Car thefts will permanently go down after 2023

- **Alternative Hypothesis (H1)**: Car thefts will not go down
...
Yes because the f-value is 218
...
Yes because there is a difference between each periods. 

Headline: Car thefts down from 2023 spike, higher than pre-spike numbers

Lede: Car thefts are decreasing from their recent high two years ago. However.. cars are still being stolen at a higher rate than before 2023. 
