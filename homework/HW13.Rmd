...
They are meaningful because the observed vs the expected frequencies are never the same. 
...
Yes because the chi-square is higher than the critical and the alpha is .05 but the p-value is .02
...
Yes the expected vs the observed are different for each category. Were teachers excepting to either over perform and under perform and not varied across each grade??
