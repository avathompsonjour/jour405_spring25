...
College is becoming more and more expensive; therefore, people can't or don't want to finish their education. 
...
People with a high school education less likely to vote compared to college goers
...
High school is way less likely to go out and vote

2. Why might the weighted results be considered more accurate than the unweighted results?

It considers how this group is represented in the population vs the survey 
...
Yes but it also shows how similar they are and doesn't show much of a difference.
...
People with only high school degrees might not show up to the polls this election. New Data shows College Grads are the most likely to go to the polls this election season. 
...
The polls are so so tight and controversial now that everything needs to be considered

2. How might the differences between weighted and unweighted results affect how you would report on this data?
The jump from 70 to 73 percent for high school grads in influential; however, most of the data is very close. 
3. What additional information would you want to know about how the weights were calculated before using this data in a news story?
  The weight difference are close but can be within the margin of error. 
