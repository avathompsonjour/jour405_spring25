...
There is some imporvement because these test scores are higher than the mean
...
The mean is higher but the SD is lower, meaning less variation in the scores
...
The reading scores are slightly higher than the previous average
...
**Hypotheses:**
Null: The new reading program does improve reading scores
Alternative: The new reading program doesn't improve reading scores
...
The p-value is so incredibly small, meaning there is not enough evidence to suggest the new reading program is effective enough to raise scores. 
...
Test scores are slightly up, not due to new reading program 
Averages are up for state testing but it's not due to the Superindependent's new program, new data reports. 

### Reflection Question 6:
What metrics or outcomes beyond test scores might be important to track for assessing reading performance?
median rather than average because one person can sway the average.
