...
It is a vague negative linear relationship
...
The residuals, coefficents and f-statistic
...
the p-value is less than .05, therefore we can accept the null hypothesis
...
Carderock Springs Elementary and Cold Spring Elementary have the highest residuals. Cold springs is in Potomac which is mainly White and Asian. Carderock Springs is nearby and is still mainly White and has a small Asian and Hispanic population. 
...
it is a negative relationship, showing the math scores are decreasing and would be worth looking into changing the policies. 
