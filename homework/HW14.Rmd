...
I would it would be a city with different race probabilities because some cities like Largo have a really high Black population but low white one. Lake Shore has a high white race probability but a low Black one
```{r race-prob}
md_cities <- md_cities |>
  mutate(
...
within Maryland's population, you will have at least a 5 out of 10 chance where two random people will be hispanic. 
...
Lake Shore, Maryland is the least diverse. While Langely Park, Wheaton and Adelphi are the 3 most diverse. The three most diverse are in the Moco/Prince George's County border area, near Washington, D.C. Lake Shore, Maryland is very close to the bay but isn't technically eastern shore. 
...
Most diverse MD areas in DC suburbs, new data finds

Maryland's most diverse cities are in the bordering counties to Washington, D.C., new data finds. 

The Diversity Index is defined as the chance that two random people are different by race or ethnicity. The Diversity Index is on a scale of 0 to 100, with 100 being the most diverse. 

Langley Park, Wheaton and Adelphi had the highest Diversity Indexes in the state. 
