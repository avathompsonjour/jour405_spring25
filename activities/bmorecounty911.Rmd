...
The patterns are the amount of calls very spreadic, it is obvious the mean is 10 but there are sometimes so many calls or very little calls. The horizontal lines would either be 20 or more or 5 or less. 
...
I thought the unusually high and the unusally low would be a lot different. I thought the highs would be a lot higher and the lows would be a lot lower. 
...
The highest day with 9-1-1 calls is the farthest from the average, therefore, making it the most unusual outlier.
...
Some days see random spikes of 9-1-1 calls, indicating emergency services face longer wait times on some days. However, some days see all-time lows. 
