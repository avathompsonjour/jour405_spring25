...
The mean score varies greatly amongst the community, private and public colleges. Private and community colleges see the greatest difference with almost a 400 point difference. However, public colleges are only behind private schools by 75 points in average. 
...
Yes, there is a significant difference in SAT scores across college types especially private vs community
2. Which specific college types differ from each other?
Private vs. Community has a 366.96 point difference, public vs community has a difference between 292.55, public vs private has a difference of 74.4
3. How large are these differences?
Can vary from 74.4 points to 366.96 points
...
Private College students averages score on SAT 350+ points more compared to Community College

Community college students lag on the SAT on average compared to private school students, new data reports. 

Private school students on average score higher on the SAT compared to public school and community college students. 
