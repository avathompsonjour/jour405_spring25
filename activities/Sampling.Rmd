...
The means are sort of similar but the standard deviations varied easier based on population size. However... when the sample size dropped to 10, the mean and SD changed more. 
